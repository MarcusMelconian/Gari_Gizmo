...
const FeelingHandler = {
  ...
  /*
   * Asynchronous, waiting for the http request to be complete before returning
   * Calls http function with Id 10
   */
  async handle(handlerInput) {
    await httpGet('10');
...
const JokeHandler = {
  ...
  /*
   * Asynchronous, waiting for the http request to be complete before returning
   * Calls http function with Id 11
   */
  async handle(handlerInput) {
    await httpGet('11');
...
const ExerciseHandler = {
  ...
  /*
   * Asynchronous, waiting for the http request to be complete before returning
   * Calls http function with Id 12
   */
  async handle(handlerInput) {
    await httpGet('12');
...
const BallHandler = {
  ...
  /*
   * Asynchronous, waiting for the http request to be complete before returning
   * Calls http function with Id 13
   */
  async handle(handlerInput) {
    await httpGet('13');
...
const RaveHandler = {
  ...
  /*
   * Asynchronous, waiting for the http request to be complete before returning
   * Calls http function with Id 14
   */
  async handle(handlerInput) {
    await httpGet('14');
